...
Therefore, the source code of the \learnpad platform which is released under 
any open-source licence can be accessed on the web at the following address:
...
Travis-CI~\cite{\url{https://travis-ci.org/}} and it is accessible at the 
following link:
